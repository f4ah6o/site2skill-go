...
This script searches through the Markdown documentation files in the docs/ directory.
...
def main():
    ...
    parser.add_argument("--skill-dir", default=str(default_skill_dir), help="Skill directory")
